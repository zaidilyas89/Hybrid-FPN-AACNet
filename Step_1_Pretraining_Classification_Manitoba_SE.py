...
# from utilities.efficientNet_FPN.efficientnet_hilo_fusion_encoder_all_hierarchies_with_classification_head_efficientb3 import model_Hilo
...
opt['weight_decay'] = .0
opt['loss_option'] = 'MSE'
opt['model_name'] = 'Step_1_SE_Manitoba'
opt['patience'] = 50
